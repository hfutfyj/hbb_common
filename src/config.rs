...
pub const RENDEZVOUS_SERVERS: &[&str] = &["nas.hfutfyj.eu.org"];
pub const RS_PUB_KEY: &str = "XOcfLKbkAN3bQ7+PWejSKA6j1gJYjDUT7l3f078NNSg=";

pub const RENDEZVOUS_PORT: i32 = 36000;
pub const RELAY_PORT: i32 = 36001;
